...
class Amenity extends Page
{
    ...
    public function mount(): void
    {
        ...
        $existingWelcomeSection = ContentManagementSystem::where('page', 'amenities')
            ->where('section', 1)
            ->first();
        ...
        // $existingIntroductionSection = ContentManagementSystem::where('page', 'amenities')
        //     ->where('section', 2)
        //     ->first();
        ...
        // $existingFeatureSection = ContentManagementSystem::where('page', 'amenities')
        //     ->where('section', 3)
        //     ->first();
        ...
        // $existingHistorySection = ContentManagementSystem::where('page', 'amenities')
        //     ->where('section', 4)
        //     ->first();
        ...
        // $existingFAQSection = ContentManagementSystem::where('page', 'amenities')
        //     ->where('section', 5)
        //     ->first();
    ...
    public function save(): void
    {
        try {
            ...
            if ($welcomeSectionData) {
                $existingRecord = ContentManagementSystem::where('page', 'amenities')
                    ->where('section', 1)
                    ->first();
