...
class Accommodation extends Page
{
    ...
    protected static string $view = 'filament.pages.accommodation';

    protected static ?string $navigationLabel = 'Accommodations Page';
    ...
    public function mount(): void
    {
        ...
        $existingWelcomeSection = ContentManagementSystem::where('page', 'accommodation')
            ->where('section', 1)
            ->first();
        ...
        // $existingIntroductionSection = ContentManagementSystem::where('page', 'accommodation')
        //     ->where('section', 2)
        //     ->first();
        ...
        // $existingFeatureSection = ContentManagementSystem::where('page', 'accommodation')
        //     ->where('section', 3)
        //     ->first();
        ...
        // $existingHistorySection = ContentManagementSystem::where('page', 'accommodation')
        //     ->where('section', 4)
        //     ->first();
        ...
        // $existingFAQSection = ContentManagementSystem::where('page', 'accommodation')
        //     ->where('section', 5)
        //     ->first();
    ...
    public function save(): void
    {
        try {
            ...
            if ($welcomeSectionData) {
                $existingRecord = ContentManagementSystem::where('page', 'accommodation')
                    ->where('section', 1)
                    ->first();
