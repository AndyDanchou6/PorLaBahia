...
class RestaurantMenu extends Page
{
    protected static ?string $model = ContentManagementSystem::class;

    protected static ?string $navigationIcon = 'heroicon-o-book-open';

    protected static string $view = 'filament.pages.restaurant-menu';
    ...
    public function mount(): void
    {
        ...
        $existingWelcomeSection = ContentManagementSystem::where('page', 'restaurant_menu')
            ->where('section', 1)
            ->first();
        ...
        // $existingIntroductionSection = ContentManagementSystem::where('page', 'restaurant_menu')
        //     ->where('section', 2)
        //     ->first();
        ...
        // $existingFeatureSection = ContentManagementSystem::where('page', 'restaurant_menu')
        //     ->where('section', 3)
        //     ->first();
        ...
        // $existingHistorySection = ContentManagementSystem::where('page', 'restaurant_menu')
        //     ->where('section', 4)
        //     ->first();
        ...
        // $existingFAQSection = ContentManagementSystem::where('page', 'restaurant_menu')
        //     ->where('section', 5)
        //     ->first();
    ...
    public function save(): void
    {
        try {
            ...
            if ($welcomeSectionData) {
                $existingRecord = ContentManagementSystem::where('page', 'restaurant_menu')
                    ->where('section', 1)
                    ->first();
